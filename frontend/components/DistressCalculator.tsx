    ...
    for (let i = 0; i < numLoans; i++) {
      loanFields.push(
        <div key={i} className="mb-6 p-4 border-2 border-black bg-slate-100">
          <h3 className="font-bold text-black uppercase tracking-wider mb-4 border-b-2 border-black pb-2">
            Loan {i + 1} Details
          </h3>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (!newLoanDetails[i])
                    newLoanDetails[i] = { interestRate: "", tenure: "" };
    ...
    <div className="max-w-3xl mx-auto mt-8 p-4">
      ...
      <div className="bg-[#FFD700] border-2 border-black p-6 mb-6">
        ...
        <p className="text-black font-medium mt-2">
          Enter your current loan history and financial details to calculate a
          real-time agricultural distress index.
        </p>
      </div>
      ...
      {score !== null ? (
        <div className="bg-white border-2 border-black p-8 text-center mb-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          ...
          <div
            className={`text-6xl font-black p-8 border-4 inline-block mb-4 ${getScoreColor(score)}`}
          >
            {score}/100
          </div>
          <p
            className={`text-xl font-bold uppercase tracking-wider ${getScoreColor(score).split(" ")[0]}`}
          >
            {getScoreLabel(score)}
          </p>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, outstandingDebt: e.target.value })
                }
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, activeLoans: e.target.value })
                }
          ...
          <div className="space-y-6 mb-8 border-t-2 border-black pt-6">
            ...
            <div>
              <label className="block text-sm font-bold text-black uppercase tracking-wider mb-3">
                Any Defaults or Missed Payments in last 12 months?
              </label>
              <div className="flex gap-4">
                <label className="flex items-center gap-2 cursor-pointer font-bold">
                  <input
                    ...
                    name="default"
                    value="yes"
                    checked={formData.recentDefaults === "yes"}
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        recentDefaults: e.target.value,
                      })
                    }
                ...
                <label className="flex items-center gap-2 cursor-pointer font-bold">
                  <input
                    ...
                    name="default"
                    value="no"
                    checked={formData.recentDefaults === "no"}
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        recentDefaults: e.target.value,
            ...
            <div>
              <label className="block text-sm font-bold text-black uppercase tracking-wider mb-3">
                Any major crop loss (climate/pests) in last 2 years?
              </label>
              <div className="flex gap-4">
                <label className="flex items-center gap-2 cursor-pointer font-bold">
                  <input
                    ...
                    name="cropLoss"
                    value="yes"
                    checked={formData.cropLoss === "yes"}
                    onChange={(e) =>
                      setFormData({ ...formData, cropLoss: e.target.value })
                    }
                    className="w-5 h-5 accent-[#003366]"
                  />
                  YES
          ...
          <button
            type="submit"
            className="w-full bg-[#058b2d] text-white font-black text-lg py-4 border-2 border-black uppercase tracking-widest hover:bg-blue-800 flex items-center justify-center gap-3 transition-colors"
          >
