      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ expected_harvest_date: e.target.value })
            }
            required
            className="w-full border border-black p-3 rounded-none text-black bg-white focus:outline-none focus:ring-2 focus:ring-[#003366]"
          />
      ...
      <div className="flex flex-col gap-2">
            ...
            return (
              <button
                ...
                className={`p-3 border text-sm font-semibold text-left flex items-center justify-between cursor-pointer transition-all ${
                  isSelected
                    ? "bg-[#058b2d] text-white border-black ring-2 ring-yellow-300 shadow-sm"
        ...
        <div className="mt-1">
          <select
            ...
            value={soilType}
            onChange={(e) =>
              onChange({ soil_type: e.target.value as SoilType })
            }
            required
        ...
        {soilType === "Other" && (
          <div className="bg-yellow-50 border border-yellow-400 p-3 mt-2">
            <label
              htmlFor="custom-soil-input"
              className="font-bold text-black text-xs block mb-1"
            >
      ...
      <div className="flex flex-col gap-2">
        ...
        {irrigationType === "Other" && (
          <input
            ...
            onChange={(e) =>
              onChange({ custom_irrigation_type: e.target.value })
            }
