      ...
      <div className="bg-white border-2 border-black p-6 rounded-none shadow-none">
        ...
        {!isSupabaseConfigured && (
          <div className="mb-4 bg-amber-50 border border-amber-500 p-2 text-xs text-amber-900 font-semibold">
            ⚡ Demo / Local Mode: Database operating in client mode. Credentials will validate directly.
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="login-mobile" className="font-bold text-black text-sm">
              {t('mobileNumber')} *
            </label>
            <input
              id="login-mobile"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="login-password" className="font-bold text-black text-sm">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#003366] text-white font-bold border border-black p-3.5 cursor-pointer hover:bg-blue-800 rounded-none outline-none focus:ring-2 focus:ring-yellow-300 disabled:opacity-50"
          >
        ...
        <div className="mt-6 text-center text-sm border-t border-gray-200 pt-4">
          ...
          <Link href="/signup" className="text-[#003366] font-bold underline hover:text-blue-800">
            {t('signupTitle')}
          </Link>
        </div>
      </div>
